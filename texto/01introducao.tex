...
\begin{enumerate}[\quad i.]
	\item Projetar e implementar um protocolo aberto de comunicação para ser utilizada em uma rede de sensores sem fio, e
	\item Projetar e implementar um algoritmo de aprendizagem de máquina ou mineração de dados de modo a prover automação residencial.
\end{enumerate}
