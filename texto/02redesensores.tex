...
Esta seção tem como fim elaborar o projeto de uma rede de sensores, a fim de alcançar o objetivo (i) do trabalho. Conforme mencionado, este item objetiva desenvolver um protocolo aberto em nível de aplicação, definindo o formato e conteúdo das mensagens a serem transmitidas entre os dispositivos e provendo interoperabilidade entre os dispositivos aderentes à especificação.

Para tanto, é importante levantar as características dos protocolos de comunicação subjacentes existentes, correspondentes às camadas de rede de nível inferior, sobre as quais o protocolo de aplicação a ser desenvolvido será executado. A seção \ref{sec:commprot} efetua uma análise dos protocolos de comunicação existentes.
...
\begin{table}[h]
	...
	\begin{tabu}{|m{6cm}|m{7cm}|}
		...
		Acesso ao meio & CSMA-CA \\ \hline
		Alcance típico & De 10m a 75m \\
		\hline
	\end{tabu}
...
\begin{table}[h]
	...
	\tabulinesep = 4mm
	\begin{tabu}{|m{2cm}|m{4cm}|m{4cm}|m{4cm}|}
		\hline
		\multicolumn{1}{|c}{\textbf{Protocolo}}& \multicolumn{1}{|c}{\textbf{Vantagens}} & \multicolumn{1}{|c}{\textbf{Desvantagens}} & \multicolumn{1}{|c|}{\textbf{Aplicações}} \\ \hline
		ZigBee & 
		\parbox{4cm}{		
		\textbullet Suporte a redes em malha;\\
		\textbullet Suporte a roteamento \textit{multihop};\\
		\textbullet Alcance elevado;\\
		\textbullet Popular.
		}
		& 
		Padrão parcialmente aberto
		& Atuadores e sensores genéricos \\ \hline
		
		6LoWPAN &
    \parbox{4cm}{
		\textbullet Suporte a redes em malha;\\
		\textbullet Suporte a roteamento \textit{multihop};\\
		\textbullet Padrão aberto;\\
		\textbullet Suporte a redes IP;\\
		\textbullet Alto alcance
    } &
		Baixa popularidade &
		Atuadores e sensores genéricos \\ \hline
		...
		Popular&
    \parbox{4cm}{
			\textbullet Baixo alcance;\\
			\textbullet Sem suporte a roteamento \textit{multihop};
		} &
		Atuadores, Smartphones no mesmo cômodo \\ \hline
		
		Z-Wave &
		\parbox{4cm}{
			\textbullet Suporta redes em malha;\\
			\textbullet Suporte a roteamento \textit{multihop};\\
			\textbullet Alto alcance
		}&
		\parbox{4cm}{
			\textbullet Padrão parcialmente aberto;\\
			\textbullet Baixa popularidade
		}&
		Atuadores \\ \hline
	\end{tabu}
\end{table}
